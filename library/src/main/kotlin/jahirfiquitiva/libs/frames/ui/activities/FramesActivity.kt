...
abstract class FramesActivity : BaseFramesActivity<FramesKonfigs>(), FavsDbManager {
    ...
    private fun buildTabs() {
        val showTexts = false //boolean(R.bool.show_texts_in_tabs)
        val showIcons = true//boolean(R.bool.show_icons_in_tabs)
        val reallyShowTexts = showTexts || (!showTexts && !showIcons)
        val expectedTabCount = if (hasCollections) 4 else 3
